        ...
        <div className="space-y-6 mt-6">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-6 text-white">
              <div className="flex gap-6">
                ...
                <div className="flex-shrink-0">
                  <div className="w-32 h-44 bg-white/20 backdrop-blur rounded-lg flex items-center justify-center shadow-xl">
                    {libro.copertina ? (
                      <img
                        src={libro.copertina}
                        alt={libro.titolo}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 text-sm">{libro.isbn}</p>
                  </div>
                </div>
                ...
                {libro.editore && (
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      <p className="text-xs text-gray-500">Editore</p>
                      <p className="font-medium text-gray-900 text-sm">{libro.editore}</p>
                    </div>
                  </div>
                )}
                ...
                {libro.annoPubblicazione && (
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900 text-sm">{libro.annoPubblicazione}</p>
                    </div>
                  </div>
                )}
                ...
                {libro.posizione && (
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900 text-sm">{libro.posizione}</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          {libro.descrizione && (
            <Card className="border-0 shadow-md">
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">{libro.descrizione}</p>
              </CardContent>
            </Card>
          )}
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-4 text-center">
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{libro.prestitiTotali || 0}</p>
                  <p className="text-xs text-gray-500">Prestiti totali</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-xs text-gray-500">Giorni medi</p>
                </div>
              </div>
            </CardContent>
          </Card>
